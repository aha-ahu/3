...
const LETTER_TEXT = `Gửi Quỳnh Châu
Lời nhắn này đến từ 1 người trong 8 tỷ người trên trái đất
Xin chào! Chắc nớ đang tò mò về bức thư này lắm nhỉ? Tụi mình có thể coi là quen hoặc chưa quen, đố nớ biết là ai đó:)). Thấm thoát mà đây đã là lần 8/3 cuối cùng của thời học sinh rồi, nhanh thật nớ nhỉ. Nhân ngày đặc biệt này, bạn muốn gửi lời cảm ơn chân thành vì những điều nớ đã làm(dù là nhỏ nhất). Chúc nớ có một ngày 8/3 thật ý nghĩa, luôn hạnh phúc và rạng rỡ nhé. Chặng đường phía trước chắc chắn sẽ có chút vất vả, mong nớ sẽ luôn kiên trì để chạm tay vào nguyện vọng 1 mình mơ ước. Xứng đáng với tất cả công sức nớ đã bỏ ra. Chúc nớ sau này luôn vững bước, tận hưởng trên con đường đã chọn và chẳng bao giờ phải thốt lên hai chữ "giá như".
Goodluck🍀🍀🍀`;
  ...
  return new Promise((resolve) => {
    ...
    function typeNextChar() {
      if (charIndex < totalChars) {
        ...
        elements.letterText.textContent += char;
        charIndex++;
